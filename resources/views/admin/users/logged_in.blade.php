            ...
            <table class="categories-show-table table table-hover table-striped table-bordered">
                <thead class="thead-primary">
                    <tr>
                        ...
                        <th scope="col">@lang('Referer Link')</th>
                        <th scope="col">@lang('URL Visited')</th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td data-label="@lang('Referer')">
                            @if ($data->referer !== "")
                            <a href="{{ $data->referer }}" target="_blank" class="btn btn-sm btn-outline-primary btn-rounded"
                                data-original-title="@lang('View link')"></a>
                            @endif
                        </td>
                        <td data-label="@lang('Visited')">
                            @if ($data->visited !== "")
                            <a href="{{ $data->visited }}" target="_blank" class="btn btn-sm btn-outline-primary btn-rounded"
                                data-original-title="@lang('View link')"></a>
                            @endif
                        </td>
