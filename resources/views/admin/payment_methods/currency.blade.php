                ...
                <div class="table-responsive">
                    <table class="categories-show-table table table-hover table-striped table-bordered" >
                        ...
                        @if($method->currency_lists)
                            @foreach(json_decode($method->currency_lists) as $key => $serviceitem)
                                <tr >
                                    <td data-label="@lang('Name')">{{ $serviceitem }}</td>
                                    <td data-label="@lang('Action')">
                                        <a href="javascript:void(0)"
                                            class="btn btn-sm btn-outline-danger deleteBtn"
                                            data-toggle="modal"
                                            data-toggle="modal" data-target="#disableModal"
                                            data-route="{{route('admin.payment.methods.currencydestroy',[$method->id,$serviceitem ? $serviceitem : '1'])}}">
                    ...
                    <div class="card-body">
                        <form method="post" action="{{route('admin.payment.methods.currencycreate')}}"
