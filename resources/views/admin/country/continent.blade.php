...
@section('content')
    ...
    <div id="crudApp">
        ...
        <div class="card card-primary m-0 m-md-4 my-4 m-md-0 shadow">
            <div class="card-body">
                @if(adminAccessRoute(config('role.continent_list.access.add')))
        ...
        var app = new Vue({
            ...
            methods: {
                ...
                createItem() {
                    ...
                    var _this = this;
                    axios.post("{{route('admin.store.continent')}}", this.newItem)
                        .then(response => {
                ...
                updateItem() {
                    ...
                    axios.post("{{route('admin.update.continent')}}", this.oldItem)
                        .then(response => {
                            var data = response.data;
                            if (data.status === 'success') {
                ...
                deleteItem(id) {
                    ...
                    axios.post("{{route('admin.delete.continent')}}", social)
                        .then(res => {
                            var data = res.data;
                            if (data.status === 'success') {
                                $("#DelModal").modal('hide');
