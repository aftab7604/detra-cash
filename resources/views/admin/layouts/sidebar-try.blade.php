<aside class="left-sidebar" data-sidebarbg="skin6">
    ...
    <div class="scroll-sidebar" data-sidebarbg="skin6">
        ...
        <nav class="sidebar-nav">
            <ul id="sidebarnav">
                @if(adminAccessRoute(config('role.initials.items.dashboard.access.view')))
                ...
                @if(adminAccessRoute(config('role.initials.items.manage_staff.access.view')))
                    <li class="sidebar-item">
                ...
                @if(adminAccessRoute(config('role.initials.items.staff_activity_log.access.view')))
                    <li class="sidebar-item">
                ...
                @if(adminAccessRoute(config('role.initials.items.staff_loggedin_log.access.view')))
                    <li class="sidebar-item">
                ...
                @if(adminAccessRoute(config('role.initials.items.identify_form.access.view')))
                    <li class="sidebar-item">
                ...
                @if(adminAccessRoute(config('role.manage_remittance.items.service_list.access.view')))
                    ...
                    <li class="sidebar-item">
                        ...
                        <ul aria-expanded="false" class="collapse first-level base-level-line">
                            ...
                            @endif
                            @if(!adminAccessRoute(config('role.manage_remittance.items.service_info.access.view')))
                            <li class="sidebar-item">
                            ...
                            @endif
                            @if(adminAccessRoute(config('role.manage_remittance.items.continent_list.access.view')))
                            <li class="sidebar-item">
                            ...
                            @endif
                            @if(adminAccessRoute(config('role.manage_remittance.items.country_list.access.view')))
                            <li class="sidebar-item">
                    ...
                    @if(adminAccessRoute(config('role.manage_remittance.items.purpose_list.access.view')))
                    <li class="sidebar-item">
                ...
                @if(adminAccessRoute(array_merge(config('role.manage_remittance.items.manage_coupon.access.view'), config('role.manage_remittance.items.manage_coupon.access.view'))))
                    <li class="sidebar-item">
                        <a class="sidebar-link has-arrow" href="javascript:void(0)" aria-expanded="false">
