@if(isset($templates['calculation'][0]) && $calculation = $templates['calculation'][0])
    <section id="home-banner" style="background-image: linear-gradient(to right , rgba(81, 149, 211,0.8), rgba(0,0,0,0.65)), url( https://detracash.com/assets/uploads/content/64620ff354a6e1684148211.jpg)">
            ...
            <div class="row align-items-center" id="basicCalcInfo">
                ...
                <div class="col-xl-8 col-lg-8">
                        ...
                        <div class="content-wrapper">
                            ...
                            <div>
                                <ul class="ctp-list">
                                    <li class="list-design"><img decoding="async" src="{{asset('/assets/circle-check.svg')}}" alt="image"> @lang('Great exchange rates')</li>
                                    <li class="list-design"><img decoding="async" src="{{asset('/assets/circle-check.svg')}}" alt="image"> @lang('No hidden fees')</li>
                                    <li class="list-design"><img decoding="async" src="{{asset('/assets/circle-check.svg')}}" alt="image"> @lang('24/7 Transfers')</li>
                                    <li class="list-design"><img decoding="async" src="{{asset('/assets/circle-check.svg')}}" alt="image"> @lang('5-star customer rating')</li>
                                    <li class="list-design"><img decoding="async" src="{{asset('/assets/circle-check.svg')}}" alt="image"> @lang('Award-winning service')</li>
                                </ul>
                            </div>
                            <div class="get-strated">
                                ...
                                <div class="video-button video_btn_banner">
                                    <button type="button" data-toggle="modal" data-target=".video">
                                        <i class="icofont-ui-play"></i>
                                    </button>
                                    <div class="modal fade video" tabindex="-1" aria-hidden="true" style="display: none;">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <iframe width="560" height="315" src="https://www.youtube.com/embed/L6O7YL3r-9I" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen=""></iframe>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row justify-content-between my-4">
                                    <div class="col-12 text-center">
                                        ...
                                        <div class="d-flex justify-content-between">
                                            <div class="left-side">
                                                <h4 class="text--base remove-coupon" style="font-size: 15px;">{{ trans('Have a coupon code?') }}</h4>
                                            </div>
                                            <div class="right-side">
                                                <a class="btn btn-success" style="background-color: #5ac8e4;" @click="applycupon"> Apply</a>
                                            </div>
                                        </div>
