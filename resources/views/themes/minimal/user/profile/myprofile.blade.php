                ...
                <div class="overview mx-lg-5 mt-3 mt-md-0">
                    <div class="overview-list search-log">
                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                            ...
                            @if((config('basic.twofaotp') || config('basic.twofaauth')) )
                            <li class="nav-item" role="presentation">
                        ...
                        <div class="tab-content " id="myTabContent">
                            ...
                            <div id="fa"
                                    ...
                                    <div class="row mb-5">
                                        ...
                                        <div class="col md-3">
                                        <p class="text-muted h3 mt-3">@lang('Select OTP or Authenticator')</p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 text-center d-none" id="authenticator">
                                            ...
                                            @foreach(json_decode(decrypt(auth()->user()->two_factor_recovery_codes)) as $item)
                                                    <li class="text-left" style="margin-left:7rem;">
                                                    {{ $loop->iteration }}. &nbsp;&nbsp;&nbsp;&nbsp;{{  $item }}  
                                                    </li>         
                                            @endforeach
                                            <p class="text-muted h3 mt-3">@lang('Please make sure to copy and save your recovery codes.')</p>
                                            </ul>
                                            @endif
                                        </div>
                                    </div>
...
@push('script')
    <script>
        ...
        // check 2FA
        @if(config('basic.twofaotp') || config('basic.twofaauth') )
        @if(config('basic.twofaotp') && auth()->user()->two_fa)
        $('#select2fa').val(1).trigger('change');
        @elseif(config('basic.twofaauth') && auth()->user()->two_factor_secret!=null)
        $('#select2fa').val(2).trigger('change');
        @else
        $('#select2fa').val("").trigger('change');
        @endif
       @endif
        });
    </script>
