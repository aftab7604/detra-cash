...
class ManualGatewayController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $getGateway->wpercentage_charge = $request->wpercentage_charge;
            $getGateway->fixed_charge = $request->fixed_charge;
            $getGateway->wfixed_charge = $request->wfixed_charge;
            ...
            log_admin_activity('New payment method', 'Added a new payment method ('.$request->name.')');
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            $getGateway->status = $request->status;
            $getGateway->withdraw_status = $request->withdraw_status;
            $getGateway->note = $request->note;
            $res = $getGateway->save();
            ...
            log_admin_activity('Update payment method', 'Updated payment method ('.$request->name.')');
            return back()->with('success', 'Gateway data has been updated.');
