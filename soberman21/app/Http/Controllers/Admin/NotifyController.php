...
class NotifyController extends Controller
{
    ...
    public function notifyConfigUpdate(Request $request)
    {
        ...
        log_admin_activity("Update notification's configuration", "Updated notification's configuration");
    ...
    public function update(Request $request, NotifyTemplate $notifyTemplate, $id)
    {
        ...
        $template->save();
        log_admin_activity('Update notification template', 'Updated notification template');
