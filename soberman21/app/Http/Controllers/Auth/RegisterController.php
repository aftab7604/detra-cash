...
//    protected $redirectTo = '/user/dashboard';
    ...
    public function showRegistrationForm()
    {
        ...
        return view(template() . 'auth.register', compact('countries'));
    }
    ...
    public function sponsor($sponsor)
    {
        ...
        $countries = Country::where('status', 1)->get();
        return view(template() . 'auth.register', compact('sponsor','countries'));
    }
    ...
    protected function create(array $data)
    {
        ...
        $country = Country::where('iso_code', $data['country'])->first('name');
     ...
     */
	//Old function
    protected function old_registered(Request $request, $user)
    {
