...
<div class="card  m-0 m-md-4 my-4 m-md-0 shadow">
    <div class="card-header bg-dark py-3 d-flex flex-row align-items-center justify-content-between">
        <h6 class="m-0 font-weight-bold text-white">@lang('Email Configuration')</h6>
    </div>
        ...
        <div class="card-body">
            <form action="" method= "POST">
                ...
                @if(adminAccessRoute(config('role.email_controls.access.edit')))
