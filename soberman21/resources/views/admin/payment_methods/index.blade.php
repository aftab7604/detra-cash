                    ...
                    <div class="card-body">
                        <table class="table ">
                            ...
                            <tr>
                                ...
                                <th scope="col">@lang('Withdraw status')</th>
                                @if(adminAccessRoute(config('role.payment_method.access.edit')))
                                ...
                                @foreach($methods as $method)
                                    <tr data-code="{{ $method->code }}">
                                        ...
                                        <td data-label="@lang('Status')">
                                            ...
                                            {!!  $method->status == 1 ? '<span class="badge badge-success badge-pill">'.trans('Active').'</span>' : '<span class="badge badge-danger badge-pill">'.trans('Inactive').'</span>' !!}
                                        </td>
                                        <td data-label="@lang('Status')">
                                            {!!  $method->withdraw_status == 1 ? '<span class="badge badge-success badge-pill">'.trans('Active').'</span>' : '<span class="badge badge-danger badge-pill">'.trans('Inactive').'</span>' !!}
                                        </td>
                                        @if(adminAccessRoute(config('role.payment_method.access.edit')))
...
@push('js-lib')
    <script src="{{ asset('assets/admin/js/jquery-ui-1-12-1.js') }}"></script>
@endpush
