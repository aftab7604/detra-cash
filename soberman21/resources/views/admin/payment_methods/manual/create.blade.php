                        ...
                        <form method="post" action=""
                            ...
                            <div class="row">
                                <div class="form-group col-md-6 col-6">
                                    ...
                                    @if ($errors->has('wpercentage_charge'))
                                        <span class="invalid-text">
                                                {{ trans($errors->first('wpercentage_charge')) }}
                                            </span>
                                    @endif
                                </div>
                                <div class="form-group col-md-6 col-6">
                                    ...
                                    @if ($errors->has('wfixed_charge'))
                                        <span class="invalid-text">
                                                {{ trans($errors->first('wfixed_charge')) }}
                                            </span>
                                    @endif
                                </div>
                            </div>
