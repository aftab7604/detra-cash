                ...
                if (levelGenerate !== '' && levelGenerate > 0) {
                    for (var i = 0; i < parseInt(levelGenerate); i++) {
                        viewHtml += `<div class="input-group mt-4">
                            ...
                            <input name="amount[]" class="form-control" type="number" step="0.0001"  value="" required placeholder="@lang('Amount')">
                            <input name="charge[]" class="form-control" type="number" step="0.0001" required placeholder="@lang("Charge")" >
