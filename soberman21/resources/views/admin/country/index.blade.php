    ...
    <div class="card card-primary m-0 m-md-4 my-4 m-md-0 shadow">
        <div class="card-body">
            ...
            <div class="d-flex justify-content-between mb-2 text-right">
                @if(adminAccessRoute(config('role.country_list.access.add')))
                <a href="{{route('admin.country.create')}}" class="btn btn-primary btn-sm"><i class="fa fa-plus-circle"></i> {{trans('Add New')}} </a>
                @endif

                @if(adminAccessRoute(config('role.country_list.access.edit')))
                <div class="dropdown ">
                            ...
                            <td data-label="@lang('Action')">
                                <div class="dropdown show">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                        ...
                                        @if(adminAccessRoute(config('role.country_service.access.view')))
                                        ...
                                        @if(adminAccessRoute(config('role.country_limit.access.view')))
                                        <a class="dropdown-item" href="{{ route('admin.country.limit',$data) }}">
                                            <i class="fa fa-money-bill-alt text-warning pr-2"
                                               aria-hidden="true"></i> @lang('Transaction Limit')
                                        </a>
                                        @endif
                                    </div>
                                </div>
