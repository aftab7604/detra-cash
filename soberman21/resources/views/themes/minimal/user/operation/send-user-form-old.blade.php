                    ...
                    <form action="{{route('user.calculation.store')}}" method="post">
                        ...
                        <div class="transfer-form-wrapper error">
                            <div class="transfer-form">
                                <div class="row">
                                	...
                                	<div class="col-lg-3">
                                		 <label class="text-dark">{{trans('Select Service')}}</label>
				                            <select name="country_service" id="select-servicess" class="form-control">
				                            </select>
				                    ...
				                    <div class="col-lg-3">
				                        <div class="form-group">
				                            <div class="input-group mb-3">
				                                <input type="text" class="form-control" name="amount" id="amount" style="width: 62%;" onkeypress="return onlyNumber;"
				                               placeholder="Amount">
                                ...
                                <input type="hidden" name="recipient_id" value="{{Request::segment(3)}}">
...
@push('script')
   ...
   <script>
        ...
        $(document).ready(function () {
            ...
            $('#select-servicess').on("change", function (){
                let id = $(this).val();
