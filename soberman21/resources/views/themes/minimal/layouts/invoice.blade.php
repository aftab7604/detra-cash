    ...
    <div class="form-inputs pt-0" id="certDeduct">
        <div class="page6 ">
            ...
            <table  class="w-100" >
                ...
                @if(isset($invoice['Sender']['City']))
                <tr class="valign-top">
                    <td class="w-50" >{{trans('City')}}</td>
                    <td>{{@$invoice['Sender']['City']}}</td>
                </tr>
                @endif

                @if(isset($invoice['Sender']['PostCode']))
                <tr class="valign-top">
                    <td class="w-50" >{{trans('Post Code')}}</td>
                    <td>{{@$invoice['Sender']['PostCode']}}</td>
                </tr>
                @endif

                @if(isset($invoice['Sender']['Country']))
                <tr class="valign-top">
                    <td class="w-50" >{{trans('Country')}}</td>
                ...
                <tr class="valign-top">
                    <td class="w-50" >{{trans('Postal Code')}}</td>
                    <td>{{@$invoice['Recipient']['PostalCode']}}</td>
                </tr>
                <tr class="valign-top">
                    <td class="w-50" >{{trans('State')}}</td>
                    <td>{{@$invoice['Recipient']['State']}}</td>
                </tr>
                <tr class="valign-top">
                    <td class="w-50" >{{trans('Country')}}</td>
                    <td>{{@$invoice['Recipient']['Country']}}</td>
                </tr>
                <tr class="valign-top">
                    <td class="w-50" >{{trans('Payment Info')}}</td>
                    <td>{!!@$invoice['Recipient']['paymentinfo']!!}</td>
                </tr>
            </table>
        </div>
    </div><!-- form-inputs -->
