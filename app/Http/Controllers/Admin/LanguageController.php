...
//        $language->rtl = isset($purifiedData->rtl);
        ...
        $path = resource_path('lang/') . $json_file;
        File::put($path, $data);
        log_admin_activity('New language', 'Added a new language ('.$language->short_name.')');
...
//        $language->rtl = $purifiedData->rtl;
        ...
        $path = resource_path('lang/') . $json_file;
        File::put($path, $data);
        log_admin_activity('Update language', 'Updated language ('.$language->short_name.')');
        return redirect(route('admin.language.index'))->with('success', 'Language Successfully Saved');
    }
    ...
    public function delete(language $language)
    {
        ...
        $language->delete();
        log_admin_activity('Delete language', 'Deleted language ('.$language->short_name.')');
    ...
    public function keywordUpdate(Request $request, $id)
    {
        ...
        log_admin_activity('Update keyword', 'Updated keyword ('.$lang->short_name.')');
